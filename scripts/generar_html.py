...
<head>
  ...
  <style>
    ...
    .descargar { margin-top: 1em; display: inline-block; padding: 0.5em 1em; background: #007acc; color: white; border-radius: 4px; text-decoration: none; }
    .modo { position: fixed; top: 1em; right: 1em; }
    :root {
      --bg: #f0f0f0;
      --fg: #000;
      --card-bg: #fff;
